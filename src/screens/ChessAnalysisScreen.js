...
const ChessAnalysisScreen = ({ navigation }) => {
    ...
    const pgnViewerRef = useRef(null); 
        ...
        <View style={styles.container}>
            ...
            <View style={styles.boardSection}>
                <View style={styles.boardRow}>
                    ...
                    <View style={[styles.boardWrapper, { width: BOARD_SIZE, height: BOARD_SIZE }]}>
                            {isLoading ? (
                                <View style={[styles.loadingContainer, { width: BOARD_SIZE, height: BOARD_SIZE }]}>
                ...
                <View style={styles.contentSection}>
                    {activeTab === 'Analysis' ? (
                        <ScrollView 
                            ...
                            // contentContainerStyle={{ paddingBottom: 100 }} // Added padding for fixed bar
                        >
                            {/* Header Info */}
                            ...
                            {liveAnalysis ? (
                                ...
                                <View style={styles.placeholderContainer}>
                                    <Text style={styles.placeholderText}>
                                        {!pgn && !isLoading ? "No game loaded" : liveAnalysis ? "" : "Waiting for engine..."}
                                    </Text>
                                </View>
                            )}
            ...
            <View style={styles.fixedBottomBar}>
                ...
                <TouchableOpacity onPress={() => pgnViewerRef.current?.handlePlayPause()} style={styles.controlBtn}>
                    <Text style={[styles.controlBtnText, { fontSize: 22 }]}>{isPlaying ? "⏸" : "▶"}</Text>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
      ...
      marginTop: 20,
      display: 'none', // Hiding it just in case, or we removed the markup entirely above
  },
  inputLabel: {
      color: '#666',
      fontSize: 12,
